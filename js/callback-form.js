...
const callbackForm = document.querySelector('.callback-form-conteiner');
const callbackThanksModal = document.querySelector('#request-received');
...
userPhone.addEventListener('click', function () {
    if (!userPhone.value.trim()) {
        userPhone.value = '+38(0'
    };
});

userPhone.addEventListener('blur', function () {
    if (userPhone.value = '+38(0') {
        userPhone.value = '';
    };
});
